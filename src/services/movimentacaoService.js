...
function validarMovimentacao({
    ...
    if (!produtoId) {
        throw new Error(
            "Informe o produto da movimentação."
        );
    }
...
// ======================================================
//
// Mantida para compatibilidade com telas que utilizam
